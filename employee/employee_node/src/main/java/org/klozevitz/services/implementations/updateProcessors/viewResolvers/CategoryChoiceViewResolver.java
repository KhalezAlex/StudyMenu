...
import static org.klozevitz.enitites.appUsers.enums.views.EmployeeView.CATEGORY_CHOICE_VIEW;
...
public class CategoryChoiceViewResolver implements UpdateProcessor<Update, Long> {
    ...
    public SendMessage processUpdate(Update update, Long telegramUserId) {
        ...
        employeeRepo.setEmployeeCurrentView(CATEGORY_CHOICE_VIEW.name(), telegramUserId);

        return telegramView.categoryChoiceView(update, resources);
    }
