...
public enum CompanyView {
    ...
    EMAIL_REQUEST_VIEW("/register", List.of(UNREGISTERED_STATE, WAIT_FOR_EMAIL_STATE)),
    EMAIL_CONFIRMATION_REQUEST_VIEW("", List.of(BASIC_STATE)),
    // TODO проверить
    EMAIL_CONFIRMATION_NOTIFICATION_VIEW("", List.of(WAIT_FOR_EMAIL_CONFIRMATION_STATE)),
    WELCOME_VIEW("/start", List.of(BASIC_STATE)),
