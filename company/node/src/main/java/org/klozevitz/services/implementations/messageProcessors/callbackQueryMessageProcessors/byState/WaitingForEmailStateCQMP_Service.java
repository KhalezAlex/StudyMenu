...
public class WaitingForEmailStateCQMP_Service implements WaitingForEmailStateCQMP {
    ...
    private SendMessage abortRegistration(Update update, AppUser currentAppUser) {
        ...
        return messageUtil.addErrorMessage(answer, REGISTRATION_ABORT_NOTIFICATION_MESSAGE);
    }
}
